...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // Анимация для элементов фотогалереи на страницах фортов
    ...
    document.querySelectorAll('.gallery-item, .gallery-item-main').forEach(item => {
    ...
    // Эффект плавного появления для карточек авторов
    ...
    // Анимация пульсации для кнопок при наведении
    document.querySelectorAll('button, .fort-link, .back-link').forEach(btn => {
    ...
    document.querySelectorAll('.fort-card, .period-content, .timeline-content, .glossary-card').forEach(card => {
